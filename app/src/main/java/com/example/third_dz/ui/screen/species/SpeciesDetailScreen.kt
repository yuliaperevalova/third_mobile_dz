        ...
        Column(
            ...
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    InfoRow("Classification", species.classification)
                    InfoRow("Eye Colors", species.eye_colors)
                    InfoRow("Hair Colors", species.hair_colors)
                }
            }
